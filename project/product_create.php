    ...
    <div class="container">
        ...
        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" enctype="multipart/form-data">
            <table class='table table-hover table-responsive table-bordered'>
                <tr>
                    <td>Name</td>
                    <td><input type='text' name='name' class='form-control' value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>" /></td>
                </tr>
                <tr>
                    <td>Description</td>
                ...
                <tr>
                    <td>Price (RM)</td>
                    <td><input type='text' name='price' class='form-control' value="<?php echo isset($_POST['price']) ? htmlspecialchars($_POST['price']) : ''; ?>" /></td>
                </tr>

                <tr>
                    <td>Promotion_price (RM)</td>
                    <td><input type='text' name='promotion_price' class='form-control' value="<?php echo isset($_POST['promotion_price']) ? htmlspecialchars($_POST['promotion_price']) : ''; ?>" /></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type='date' name='manufacture_date' class='form-control' value="<?php echo isset($_POST['manufacture_date']) ? htmlspecialchars($_POST['manufacture_date']) : ''; ?>" /></td>
                </tr>
                <tr>
                    <td>Expired_date</td>
                    <td><input type='date' name='expired_date' class='form-control' value="<?php echo isset($_POST['expired_date']) ? htmlspecialchars($_POST['expired_date']) : ''; ?>" /></td>
                </tr>
                <tr>
                    <td></td>
                    <td>
